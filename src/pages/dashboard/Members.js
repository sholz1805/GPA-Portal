...
import { RiUser2Line, RiTeamLine, RiUser5Line, RiGitBranchLine   } from "react-icons/ri";
...
const cardDetails = [
    { Icon: RiUser2Line, percentage: "-0.6%", number: 60, cardLabel: "Total Leaders" },
    { Icon: RiUser5Line, percentage: "1.2%", number: 647, cardLabel: "Total Workers" },
    { Icon: RiTeamLine, percentage: "0.8%", number: 67500, cardLabel: "Total Members" },
    { Icon: RiGitBranchLine , percentage: "2.5%", number: 65, cardLabel: "Total Branches" }
  ];

const Members = () => {
  return (
    <DashboardLayout>
      <div className="text-[24px] font-[600] text-[#0D0D0D]">Members</div>
